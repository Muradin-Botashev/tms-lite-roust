...
{
    public class ActualPalletsCountReadonlyRule : BaseReadonlyRule
    {
        private ICommonDataService _dataService;

        public ActualPalletsCountReadonlyRule(ICommonDataService dataService, IUserProvider userProvider) : base(userProvider)
        {
            _dataService = dataService;
        }

        protected override string Field => nameof(OrderDto.ActualPalletsCount);
        ...
        protected override bool ChangeCheck(OrderDto dto, Order entity)
        {
            ...
            return entity == null
                ...
                || dto.ActualPalletsCount == entity.ActualPalletsCount
