...
namespace Application.BusinessModels.Orders.Actions
{
    ...
    public class CancelRequestOrderShipping : IAppAction<Order>
    {
        ...
        public CancelRequestOrderShipping(ICommonDataService dataService, INotificationService notificationService, IHistoryService historyService)
        {
            _dataService = dataService;
            _shippingAction = new CancelRequestShipping(dataService, notificationService, historyService);
