...
namespace Application.BusinessModels.Shippings.Backlights
{
    public class CarrierRequestSentBacklight : IBacklight<Shipping>
    {
        ...
        public bool IsActive(Shipping entity)
        {
